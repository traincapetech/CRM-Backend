...
exports.updateSale = async (req, res) => {
  try {
    ...
    if (sale.leadPerson) {
      ...
      if (req.body.leadPerson === null || req.body.leadPerson === undefined || req.body.leadPerson === '') {
        ...
        if (typeof req.body.leadPerson === 'string' && req.body.leadPerson.trim() !== '') {
          try {
            req.body.leadPerson = new mongoose.Types.ObjectId(req.body.leadPerson);
            console.log('Converting leadPerson string to ObjectId:', req.body.leadPerson);
          } catch (err) {
      ...
      if (req.body.leadPerson === null || req.body.leadPerson === undefined || req.body.leadPerson === '') {
        delete req.body.leadPerson;
        console.log('No leadPerson in request and sale has none - leaving as is');
      } else if (typeof req.body.leadPerson === 'string' && req.body.leadPerson.trim() !== '') {
        try {
          req.body.leadPerson = new mongoose.Types.ObjectId(req.body.leadPerson);
