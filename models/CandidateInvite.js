...
const candidateInviteSchema = new mongoose.Schema(
  {
    ...
    documents: {
      ...
      tenthMarksheet: { type: mongoose.Schema.Types.Mixed },
      twelfthMarksheet: { type: mongoose.Schema.Types.Mixed },
      graduationDegree: { type: mongoose.Schema.Types.Mixed },
      mastersDegree: { type: mongoose.Schema.Types.Mixed },
